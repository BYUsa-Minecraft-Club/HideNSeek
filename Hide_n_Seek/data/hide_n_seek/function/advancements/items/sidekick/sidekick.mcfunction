execute at @s run summon endermite ~ ~ ~ {Glowing:1b,DeathLootTable:"",Team:"Seekers",CustomName:'{"color":"light_purple","text":"Seeker Sidekick"}',attributes:[{id:"minecraft:attack_damage",base:1}]}
