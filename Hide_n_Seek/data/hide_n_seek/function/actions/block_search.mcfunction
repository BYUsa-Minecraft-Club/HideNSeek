...
$execute at @a[team=Seekers] run title @a[team=Hiders,distance=0..$(range)] actionbar {"text":"A nearby seeker knows your location"}
$execute at @e[team=Hiders] run title @a[team=Seekers,distance=0..$(range)] actionbar {"text":"There is a hider within $(range) range"}
